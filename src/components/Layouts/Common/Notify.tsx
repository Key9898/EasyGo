...
export default function Notify() {
  ...
  useEffect(() => {
    const handler = (e: Event) => {
      const detail = (e as CustomEvent<{ title?: string; message?: string; type?: 'success' | 'error' | 'info' }>).detail || {}
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4 flex shrink-0">
                    <button
                      ...
                      className="inline-flex rounded-lg text-slate-400 hover:text-slate-500 focus:outline-2 focus:outline-offset-2 focus:outline-orange-600"
                    >
