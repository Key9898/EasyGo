...
export default function AboutCTA({ onNavigate }: AboutCTAProps) {
    const ctaButtons = [
        {
            icon: FaCar,
            text: 'Explore Fleet',
    ...
    return (
        <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-2xl shadow-xl p-8 sm:p-12 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to Experience Better Travel?</h2>
            <p className="text-orange-100 text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of satisfied customers who trust EasyGo for their daily commutes and cross-border adventures.
            </p>
